...
*Defined in [packages/util-crypto/src/scrypt/encode.ts:20](https://github.com/polkadot-js/common/blob/2f7d5cd4/packages/util-crypto/src/scrypt/encode.ts#L20)*
