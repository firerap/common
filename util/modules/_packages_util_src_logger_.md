...
*Defined in [packages/util/src/logger.ts:44](https://github.com/polkadot-js/common/blob/2f7d5cd4/packages/util/src/logger.ts#L44)*
...
*Defined in [packages/util/src/logger.ts:103](https://github.com/polkadot-js/common/blob/2f7d5cd4/packages/util/src/logger.ts#L103)*
