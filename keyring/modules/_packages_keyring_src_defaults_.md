...
*Defined in [packages/keyring/src/defaults.ts:6](https://github.com/polkadot-js/common/blob/2f7d5cd4/packages/keyring/src/defaults.ts#L6)*
...
*Defined in [packages/keyring/src/defaults.ts:9](https://github.com/polkadot-js/common/blob/2f7d5cd4/packages/keyring/src/defaults.ts#L9)*
